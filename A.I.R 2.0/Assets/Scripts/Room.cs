...
public class Room
{
    ...
    public Room(List<Tile> tiles, string roomname)
    {
    ...
    public Room(List<Tile> tiles, string roomname, float temp, float rehumidity, float lightlv, float oxyper, float nitper, float co2per, float pressure)
    {
        roomTiles = tiles;
        roomName = roomname;
        this.temp = temp;
